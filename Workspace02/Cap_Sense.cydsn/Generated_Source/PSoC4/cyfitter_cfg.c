...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x00003300u);
...
void cyfitter_cfg(void)
{
...

	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3502u, /* Base address: 0x400F3500 Count: 2 */
			0x400F3660u, /* Base address: 0x400F3600 Count: 96 */
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA5_CFG8), 0x00200000u);

		/* UDB_PA_7 Starting address: CYDEV_UDB_PA7_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA7_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA7_CFG8), 0x00080000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC2), 0x00000040u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC2), 0x000000F4u);
